...
import { IKeepTableFilters } from "@/types/keep";
...
type Props = {
  ...
  onFilters: (newFilters: IKeepTableFilters) => void;
  onClearFilters: () => void;
  //
...
export default function KeepTableToolbar({
  ...
  const handleFilter = useCallback(() => {
    const newFilters: IKeepTableFilters = {
                  ...
                  {statusOptions.map((option) => (
                    <MenuItem key={option.label} value={option.label}>
                      <Checkbox
                        disableRipple
                        size="small"
                        checked={status.includes(option.label)}
                      />
                      {option.label}
                    </MenuItem>
                  ))}
