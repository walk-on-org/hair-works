...
import { IOfficeTableFilters } from "@/types/office";
...
type Props = {
  ...
  onFilters: (newFilters: IOfficeTableFilters) => void;
  onClearFilters: () => void;
};

export default function OfficeTableToolbar({
  filters,
  searchLoading,
  onFilters,
  onClearFilters,
  ...
  const handleFilter = useCallback(() => {
    const newFilters: IOfficeTableFilters = {
      corporation_name: corporationName,
      name: name,
    };
    onFilters(newFilters);
  }, [corporationName, name, onFilters]);
