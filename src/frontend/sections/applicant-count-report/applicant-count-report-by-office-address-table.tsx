...
import { IApplicantCountReportByOfficeAddress } from "@/types/applicant-count-report";
...
interface Props extends CardProps {
  ...
  subheader?: string;
  tableLabels: any;
  tableData: IApplicantCountReportByOfficeAddress[];
}

export default function ApplicantCountReportByOfficeAddressTable({
  title,
  subheader,
  tableLabels,
  tableData,
