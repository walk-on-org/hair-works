...
export const paths = {
  ...
  admin: {
    ...
    member: {
      root: `${ROOTS.ADMIN}/members`,
      detail: (id: string) => `${ROOTS.ADMIN}/members/${id}`,
      edit: (id: string) => `${ROOTS.ADMIN}/members/${id}/edit`,
    },
    applicant: {
      root: `${ROOTS.ADMIN}/applicants`,
      detail: (id: string) => `${ROOTS.ADMIN}/applicants/${id}`,
      edit: (id: string) => `${ROOTS.ADMIN}/applicants/${id}/edit`,
    },
    inquiry: {
      root: `${ROOTS.ADMIN}/inquiries`,
    ...
    keep: {
      root: `${ROOTS.ADMIN}/analysis/keeps`,
    },
    history: {
      root: `${ROOTS.ADMIN}/analysis/histories`,
    },
    mailmagazineConfig: {
      root: `${ROOTS.ADMIN}/analysis/mailmagazine_configs`,
      new: `${ROOTS.ADMIN}/analysis/mailmagazine_configs/new`,
      detail: (id: string) =>
        `${ROOTS.ADMIN}/analysis/mailmagazine_configs/${id}`,
      edit: (id: string) =>
    ...
    article: {
      ...
      detail: (id: string) => `${ROOTS.ADMIN}/article/articles/${id}`,
      edit: (id: string) => `${ROOTS.ADMIN}/article/articles/${id}/edit`,
    },
    articleCategory: {
      root: `${ROOTS.ADMIN}/article/article_categories`,
      new: `${ROOTS.ADMIN}/article/article_categories/new`,
      detail: (id: string) => `${ROOTS.ADMIN}/article/article_categories/${id}`,
      edit: (id: string) =>
        `${ROOTS.ADMIN}/article/article_categories/${id}/edit`,
    },
    adminUser: {
      root: `${ROOTS.ADMIN}/account/admin_users`,
      new: `${ROOTS.ADMIN}/account/admin_users/new`,
      detail: (id: string) => `${ROOTS.ADMIN}/account/admin_users/${id}`,
      edit: (id: string) => `${ROOTS.ADMIN}/account/admin_users/${id}/edit`,
    },
    adminRole: {
      root: `${ROOTS.ADMIN}/account/admin_roles`,
      new: `${ROOTS.ADMIN}/account/admin_roles/new`,
      detail: (id: string) => `${ROOTS.ADMIN}/account/admin_roles/${id}`,
      edit: (id: string) => `${ROOTS.ADMIN}/account/admin_roles/${id}/edit`,
    },
    jobCategory: {
