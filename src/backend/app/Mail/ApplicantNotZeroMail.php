...
class ApplicantNotZeroMail extends Mailable
{
    ...
    )
    {
        ...
        $this->continuation_contract_one_month_corporations = $continuation_contract_one_month_corporations;
    ...
    public function build()
    {
        return $this->to('info@walk-on.co.jp')
            ->subject('【HAIR WORKS】契約後応募があった法人お知らせ')
            ->text('mail.ApplicantNotZeroMail');
    }
}
